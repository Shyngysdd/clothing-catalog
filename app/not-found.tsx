...
export default function NotFound() {
  return (
    <main className="not-found-page mx-auto grid min-h-[70svh] max-w-[100rem] place-items-center px-4 py-12 sm:px-6 lg:px-10">
      <section className="w-full max-w-3xl border-y border-[color:var(--ink)]/20 py-10 text-center sm:py-16">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <Link href="/" className="flex min-h-12 items-center justify-center border border-[color:var(--ink)]/25 px-6 text-sm font-medium hover:border-[color:var(--accent)] hover:text-[color:var(--accent)]">На главную</Link>
        </div>
      </section>
    </main>
  );
