  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-16">
      ...
      <section className="mt-10 border-y border-[color:var(--ink)]/15 py-6">
        <div className="flex items-baseline justify-between gap-4"><div><p className="font-mono-price text-xs tracking-[0.14em] text-[color:var(--accent)]">ПРОФИЛЬ</p><h2 className="font-section mt-2 text-2xl">Личные данные</h2></div><p className="text-sm text-[color:var(--ink)]/60">Email: {customer.email}</p></div>
